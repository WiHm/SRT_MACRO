...
member_number = "1982564243" # 회원번호
password= "goku7733 # 비밀번호
arrival = "부산" # 출발지
departure = "수서" # 도착지
standard_date = "20240917" # 기준날짜 ex) 20221101
standard_time = "08" # 기준 시간 ex) 00 - 22 // 2의 배수로 입력

"""
현재 페이지에 나타난 기차 몇번째 줄부터 몇번째 줄의 기차까지 조회할지 선택 
"""
from_train_number = 2 # 몇번째 기차부터 조회할지  min = 1, max = 10
to_train_number = 9 # 몇번째 기차까지 조회할지 min = from_train_number, max = 10
